...
const STRINGS = {
  uz: {
    ...
    forResultToBoardButton: "📊 Taxtachaga qaytish",
    forResultSeeBoardButton: "📊 Taxtachani ko'rish",
  ...
  ru: {
    ...
    forResultToBoardButton: "📊 Вернуться к доске",
    forResultSeeBoardButton: "📊 Посмотреть доску",
  ...
  en: {
    ...
    forResultToBoardButton: "📊 Back to the board",
    forResultSeeBoardButton: "📊 See the board",
